    ...
    <section className="relative w-full h-[60vh] md:h-[70vh] overflow-hidden">
      ...
      <div className="relative h-full max-w-7xl mx-auto px-4 md:px-6 lg:px-8 flex flex-col items-center justify-center text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-12">
          <Button size="lg" className="backdrop-blur-md bg-primary/90 hover:bg-primary border border-primary-border" data-testid="button-post-lost-item">
            <Search className="w-5 h-5 mr-2" />
            Post Lost Item
          </Button>
          <Button size="lg" variant="outline" className="backdrop-blur-md bg-white/10 hover:bg-white/20 border-white/30 text-white" data-testid="button-report-found">
            Report Found Item
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-4xl">
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm text-white/80">Smart algorithms find potential matches</p>
          </div>
          <div className="flex flex-col items-center gap-2">
            <div className="w-12 h-12 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center">
            ...
            <p className="text-sm text-white/80">Thousands helping each other daily</p>
          </div>
          <div className="flex flex-col items-center gap-2">
            <div className="w-12 h-12 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center">
            ...
            <p className="text-sm text-white/80">85% of items successfully reunited</p>
          </div>
        </div>
      </div>
    </section>
